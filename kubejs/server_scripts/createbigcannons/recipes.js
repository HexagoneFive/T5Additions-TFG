...
function logAttributeKeys(object){
 ...
 */
function registerCBCRecipes(event){
    ...
    //#region Constants
    const MouldRecipes = {
        't5a:cbc/autocannon_recoil_spring_cast_mould': {
            'result': 'createbigcannons:autocannon_recoil_spring_cast_mould',
            'pattern': [['  A', '   '],{ A: '#tfg:hardwood' }]
        },

        't5a:cbc/autocannon_barrel_cast_mould': {
            'result': 'createbigcannons:autocannon_barrel_cast_mould',
            'pattern': [[' A ', '   '],{ A: '#tfg:hardwood' }]
        },

        't5a:cbc/autocannon_breech_cast_mould': {
            'result': 'createbigcannons:autocannon_breech_cast_mould',
            'pattern': [['A  ', '   '],{ A: '#tfg:hardwood' }]
        },

        't5a:cbc/screw_breech_cast_mould': {
            'result': 'createbigcannons:screw_breech_cast_mould',
            'pattern': [['AA ', '   '],{ A: '#tfg:hardwood' }]
        },

        't5a:cbc/very_small_cast_mould': {
            'result': 'createbigcannons:very_small_cast_mould',
            'pattern': [['A  ', 'A  '],{ A: '#tfg:hardwood' }]
        },

        't5a:cbc/small_cast_mould': {
            'result': 'createbigcannons:small_cast_mould',
            'pattern': [['AA ', 'AA '],{ A: '#tfg:hardwood' }]
        },

        't5a:cbc/medium_cast_mould': {
            'result': 'createbigcannons:medium_cast_mould',
            'pattern': [[' AA', ' AA'],{ A: '#tfg:hardwood' }]
        },

        't5a:cbc/large_cast_mould': {
            'result': 'createbigcannons:large_cast_mould',
            'pattern': [['AAA', 'AA '],{ A: '#tfg:hardwood' }]
        },

        't5a:cbc/very_large_cast_mould': {
            'result': 'createbigcannons:very_large_cast_mould',
            'pattern': [['AAA', 'AAA'],{ A: '#tfg:hardwood' }]
        },

        't5a:cbc/cannon_end_cast_mould': {
            'result': 'createbigcannons:cannon_end_cast_mould',
            'pattern': [['AAA', ' A '],{ A: '#tfg:hardwood' }]
        },

        't5a:cbc/sliding_breech_cast_mould': {
            'result': 'createbigcannons:sliding_breech_cast_mould',
            'pattern': [['A A', 'AAA'],{ A: '#tfg:hardwood' }]
        }
    ...
    for (let key in MouldRecipes) {
        let pattern = MouldRecipes[key].pattern
        createMouldRecipe(key, MouldRecipes[key].result, pattern[0], pattern[1])
    }
    ...
    function setRecipeForgeHammer(id_, ){
        const fh_path = 't5a:cbc/forge_hammer/' + id_
        const pg_path = 't5a:cbc/pressing/' + id_
    }
    ...
    event.recipes.gtceu.assembler('t5a:cbc/assembler/bronze_sliding_breech')
        .itemInputs(
            '#forge:shafts', 'createbigcannons:bronze_sliding_breechblock'
        )
        .itemOutputs(
            Item.of('createbigcannons:bronze_sliding_breech')
        )
        .EUt(GTValues.VA[GTValues.ULV])
        .duration(100)
        .circuit(5)
    ...
    event.recipes.gtceu.assembler('t5a:cbc/assembler/steel_sliding_breech')
        .itemInputs(
            '#forge:shafts', 'createbigcannons:steel_sliding_breechblock'
        )
        .itemOutputs(
            Item.of('createbigcannons:steel_sliding_breech')
        )
        .EUt(GTValues.VA[GTValues.ULV])
        .duration(100)
        .circuit(5)
    ...
    event.recipes.gtceu.assembler('t5a:cbc/assembler/cast_iron_sliding_breech')
        .itemInputs(
            '#forge:shafts', 'createbigcannons:cast_iron_sliding_breechblock'
        )
        .itemOutputs(
            Item.of('createbigcannons:cast_iron_sliding_breech')
        )
        .EUt(GTValues.VA[GTValues.ULV])
        .duration(100)
        .circuit(5)

    event.recipes.gtceu.assembler('t5a:cbc/assembler/steel_screw_breech')
        .itemInputs(
            '#forge:shafts', 'createbigcannons:incomplete_steel_screw_breech'
        )
        .itemOutputs(
            Item.of('createbigcannons:steel_screw_lock')
        )
        .EUt(GTValues.VA[GTValues.ULV])
        .duration(70)
        .circuit(5)
